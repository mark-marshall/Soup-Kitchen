...
export const FETCHING_STAFF_MEMBER = "FETCHING_STAFF_MEMBER";
export const STAFF_MEMBER_FETCHED = "STAFF_MEMBER_FETCHED";
export const PUSH_STAFF_MEMBER = "PUSH_STAFF_MEMBER";
export const ERROR_FETCHING_STAFF_MEMBER = "ERROR_FETCHING_STAFF_MEMBER"
